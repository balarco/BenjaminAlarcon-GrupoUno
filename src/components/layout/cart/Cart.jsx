                ...
                {cartItems.length > 0 && (
                    <div className="mt-8">
                        <div className="flex justify-between items-center">
                            <button onClick={clearCart} className="text-gray-400 hover:text-white focus:outline-none">Borrar Todo</button>
                            <button onClick={updateCart} className="text-gray-400 hover:text-white focus:outline-none">Actualizar</button>
                        </div>
